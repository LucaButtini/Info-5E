...
<div class="container">
    <form method="post" action="display.php">
        <!-- Campi obbligatori per nome, cognome, email e password -->
        ...
        <!-- Domanda 1 -->
        <h3>Domande</h3>
        <label for="d1">1. Cos'è un DBMS?</label><br>
        <textarea id="d1" rows="5" cols="60" name="d1"></textarea><br><br>

        <!-- Domanda 2 -->
        <label for="d2">2. Quale dei seguenti è un DBMS relazionale?</label><br>
        ...
        <label for="redis">Redis</label><br><br>

        <!-- Domanda 3 -->
        <label for="d3">3. Quali sono le principali caratteristiche di un DBMS? (Seleziona tutte le opzioni corrette)</label><br>
        <input type="checkbox" id="c1" name="d3[]" value="Gestione dati">
        <label for="c1">Gestione dati</label><br>
        <input type="checkbox" id="c2" name="d3[]" value="Alta scalabilità">
        <label for="c2">Alta scalabilità</label><br>
        <input type="checkbox" id="c3" name="d3[]" value="Supporto per crittografia">
        <label for="c3">Supporto per crittografia</label><br>
        <input type="checkbox" id="c4" name="d3[]" value="Gestione dispositivi hardware">
        <label for="c4">Gestione dispositivi hardware</label><br><br>

        <!-- Domanda 4 -->
        <label for="d4">4. Quale modello di database è più adatto per rappresentare dati gerarchici?</label><br>
        ...
        <!-- Domanda 5 -->
        <label for="d5">5. Qual è la differenza principale tra SQL e NoSQL?</label><br>
        <textarea id="d5" rows="5" cols="60" name="d5"></textarea><br><br>

        <!-- Domanda 6 -->
        <label for="d6">6. Quali sono i vantaggi principali di un database relazionale? (Seleziona più opzioni)</label><br>
