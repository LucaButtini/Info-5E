...
<form method="post" action="action_page.php">
    ...
    <input type="text" id="citta" name="citta" placeholder="Città"><br><br>
    <label for="indirizzo">Indirizzo</label><br>
    <input type="text" id="indirizzo" name="indirizzo" placeholder="Via Nome/Numero"><br><br>
    <label for="numero">Numero telefono</label><br>
    <input type="text" id="numero" name="numero" placeholder="+39 00000000"><br><br>
    ...
    <input type="number" id="francia" name="francia" min="0" value="0"><br>
    <label for="spagna">Numero aziende in Spagna</label><br>
    <input type="number" id="spagna" name="spagna" min="0" value="0"><br>
    <label for="germania">Numero aziende in Germania</label><br>
    <input type="number" id="germania" name="germania" min="0" value="0"><br>
    <label for="inghilterra">Numero aziende in Inghilterra</label><br>
    <input type="number" id="inghilterra" name="inghilterra" min="0" value="0"><br>
    <label for="stati uniti">Numero aziende in Stati Uniti</label><br>
    <input type="number" id="stati uniti" name="stati uniti" min="0" value="0"><br><br>
